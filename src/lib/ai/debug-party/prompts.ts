...
Return only this JSON object shape: {"normalizedIntent":{"productKind":"...","requestedAttributes":["..."],"exclusions":["..."]},"verdicts":[{"evidenceId":"an input evidenceId","verdict":"match|partial|exclude","reason":"short Ukrainian reason"}]}. Use the key names normalizedIntent and verdicts; do not return classifications, class, primaryProductType, requestedPrimaryProductType, requestedForm or missingQueries. You have no tools and cannot select a cart item, price, quantity, brand rating, popularity or product not supplied in candidates.
